...
@section('content')
	<div class="font-size-em-14">
		<h2> Why was <span class="font-weight-bold font-color-maroon"> MUSBE </span> created? </h3>
		...
		<p>
			<h3 class="font-weight-bold font-color-maroon"> Yi Chen Zhu </h3>

			<i class="font-size-em-10"> Developer </i>
		</p>
		...
		<p>
			<h3 class="font-weight-bold font-color-maroon"> Stephanie Tran </h3>

			<i class="font-size-em-10"> Marketer </i>
		</p>
		...
		<hr>
		<p>
			Interested in knowing more about the team or hiring us? Visit our website www.chosensolutions.ca
		</p>
