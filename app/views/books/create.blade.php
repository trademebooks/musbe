    ...
    <form action="{{ URL::route('books.store') }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                Course code*
                <br>
                <input name="course_code" type="text" placeholder="(ex. MAT 100)" size="20" {{ Input::old('course_code') ? 'value="' . e(Input::old('course_code')) . '"' : '' }}>
                <br>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                Email*
                <br>
                <input type="text" name="email" placeholder="(ex. johnsmith@hotmail.com)" size="40" {{ Input::old('email') ? 'value="' . e(Input::old('email')) . '"' : '' }}>
                <br>
